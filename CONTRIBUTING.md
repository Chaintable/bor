...
This repository is a **fork**: upstream [0xPolygon/bor](https://github.com/0xPolygon/bor)
...
a general-purpose fork of 0xPolygon/bor.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v2.8.0-ct.7`); a GitHub Release publishes the versioned images
